<template>
  <div>
    <textarea @blur="myMethod" @dblclick="showView" :style="{height:conInfo.height+'px',width:conInfo.width+'px',color:conInfo.ForeColor,fontSize:conInfo.fontSize+'pt'}" style="resize:none;" v-model="conInfo.value"></textarea>
