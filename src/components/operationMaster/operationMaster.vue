<template>
  <div v-if="!settingView" style="height:100%;position:relative;overflow-y:hidden;" @click="allNone()">
      ...
      <div class="left" style="overflow-y: auto;">
        <div v-if="lockedPatientInfo.patientId" style="height: auto;background-color: rgb(29,117,181);margin-bottom:5px;">
          ...
          <div v-if="concealmentOneData" style="padding:5px;display:flex;flex-wrap:wrap;">
            ...
            <button v-if="lockedPatientInfo.patientId" @click="openDocInformation" class="list_button">医嘱信息</button>
    ...
    <!-- 医嘱信息 -->
    <docInmormation v-if="docInmormation" v-on:closeView="closeDocInformation"></docInmormation>
    <!-- 检验结果 -->
...
import docInmormation from '@/components/checkInfo/docInmormation.vue';
...
export default {
  ...
  methods: {
    ...
    // 打开医嘱信息
    openDocInformation() {
      this.docInmormation = true
    },
    closeDocInformation() {
      this.docInmormation = false
    },
    //检查结果
    openMedical() {
      if (window.ipc) {
