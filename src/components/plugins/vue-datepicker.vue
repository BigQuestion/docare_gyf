<template>
  <div style="position: relative;" class="cov-vue-date" :class="option.wrapperClass ? option.wrapperClass : {}">
    <div class="datepickbox" style="position: relative">
      ...
      <!-- <input type="text" title="input date" placeholder="1900/01/01" class="cov-datepicker" v-model="date.time" :required="required" @focus="showCheck" :style="option.inputStyle ? option.inputStyle : {}" :class="option.inputClass ? option.inputClass : {}" /> -->
    </div>
