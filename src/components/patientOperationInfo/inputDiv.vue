<template>
	<div style="position: relative;">
		<input @dblclick="showView"  v-model="conInfo[attrName]"  v-on:blur="disShowView">
		<div v-if="nameView" style="position: absolute;top: 0px;width: 150px;height: 300px;overflow-y: auto;border:1px solid;z-index: 1;">
