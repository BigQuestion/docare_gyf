...
axios.defaults.baseURL = 'http://111.111.111.156:8090';
// axios.defaults.baseURL = 'http://192.168.131.180:8088';
 ...
 */
   ...
   * 
   */
  getLabReultList(params, config) {
    return fetch('medicalsystem/rest/medLab/getLabReultList', params)
  },
